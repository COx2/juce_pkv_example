juce_add_console_app(PKVExample
    PRODUCT_NAME "PKV implements with JUCE") 
juce_generate_juce_header(PKVExample)
...
target_compile_definitions(PKVExample
    PUBLIC
...
target_link_libraries(PKVExample
    PRIVATE
