...
public:
    ...
    juce::String generateKey(const juce::String& seed);

    // Generate a 4-byte hexidecimal seed value
    static juce::String generateSeed();
...
private:
    ...
    juce::String formatKey(const juce::String& key);

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(KeyGenerator)
};
